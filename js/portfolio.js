...
let projectDetails = (project) => {
  ...
  $('#projectDetails').html(aim + skills + details + githubrepo + " " + demo + linkBack).fadeIn();
...
let toggleProjectBox = (element) => {
  ...
  let box = "<div id=\"details\" class=\"col-xs-12 color-bg anchor\"><div class=\"container\"><div id=\"projectDetails\" class=\"projectDetails\"></div></div></div>";
