...
const Technology = () => (
  <section id="technology">
    ...
    >
      ...
      >
        Some of the technologies I've used either at work or on side projects
      </div>
      <ul className="devicons-section">
        <li>
          <svg className="devicons devicon-golang-plain" viewBox="0 0 600 600">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              fill="#F6D2A2"
	...
	M58.019,537.612c0.542-6.233,5.484-10.407,7.838-15.677"
            ...
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M49.513,91.667c-7.955-4.208-13.791-9.923-8.925-19.124
	c4.505-8.518,12.874-7.593,20.83-3.385L49.513,91.667z"
            />
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M337.716,83.667c7.955-4.208,13.791-9.923,8.925-19.124
	...
	M176.217,168.87c-6.47,15.68,3.608,47.035,21.163,23.908c-1.255-9.946,0.468-19.576,0.785-29.526L176.217,168.87z"
		...
		c13.285,0.272,24.17,14.047,34.84,2.49c11.867-12.854-5.109-25.373-18.377-30.97L178.431,138.673z"
              ...
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M176.913,138.045c-0.893-20.891,38.938-23.503,43.642-6.016
        ...
        <li>
          <svg
            className="devicons devicon-javascript-plain"
            viewBox="0 0 128 128"
          >
            <path
              fill="#F0DB4F"
        ...
        <li>
          <svg
            className="devicons devicon-typescript-plain"
            viewBox="0 0 128 128"
          >
        ...
        <li>
          <svg
            className="devicons devicon-nodejs-original"
            viewBox="0 0 128 128"
          >
            <path
              fill="#83CD29"
        ...
        <li>
          <svg
            className="devicons devicons-react-original"
            viewBox="0 0 128 128"
        ...
        <li>
          <svg className="devicons python-original" viewBox="0 0 128 128">
            <linearGradient
              id="a"
        ...
        <li>
          <svg className="devicons devicons-ruby-plain" viewBox="0 0 128 128">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              fill="#D91404"
        ...
        <li>
          <svg
            className="devicons devicon-csharp-original"
            viewBox="0 0 128 128"
          >
            <g>
              <path
        ...
        <li>
          <svg
            className="devicons devicon-mocha-plain"
          ...
          >
            ...
            <g id="plain">
              ...
              <path
                ...
                transform="translate(-8 -0.81)"
              />
              <circle className="cls-1" cx="40" cy="62.53" r="4.84" />
              <path
                className="cls-1"
        ...
        <li>
          <svg
            className="devicons devicon-mongodb-original-wordmark"
            viewBox="0 0 128 128"
          >
            <path
              fillRule="evenodd"
        ...
        <li>
          <svg
            className="devicons devicon-webpack-original"
            viewBox="0 0 128 128"
          >
        ...
        <li>
          <svg className="devicons devicon-git-plain" viewBox="0 0 128 128">
            <path
              fill="#F34F29"
        ...
        <li>
          <svg
            className="devicons devicon-docker-original"
            viewBox="0 0 128 128"
          >
            <g>
              <path
        ...
        <li>
          <svg
            className="devicons devicon-heroku-original-wordmark"
            viewBox="0 0 128 128"
          >
            <g fill="#6762A6">
